        ...
        $.ajax({ //聯合新聞網
            ...
            success: function(xml){
                $(xml).find("item").each(function(i){
                    ...
                    $("#index_body").append("<div class=\"panel panel-default\"><div class=\"panel-body\"><div class=\"media\"><div class=\"media-body\"><a class=\"media-left\" href=\"" + read_url + "\"><h1 class=\"media-heading\">" + news_title + "</h1></a><small><time datetime=\"" + news_time + "\"></time></small><h3>" + news_description + "</h3><a href=\"" + read_url + "\"><button type=\"button\" class=\"btn btn-primary\">閱讀更多...</button></a>   </div></div></div></div>");
                });
            }
        });
    }
